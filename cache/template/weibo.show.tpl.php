...
<div class="bc">
<li class="mbtl">
<a href="<?php echo tsurl('user','space',array('id'=>$strWeibo['user'][userid]))?>"><img title="<?php echo $strWeibo['user'][username];?>" alt="<?php echo $strWeibo['user'][username];?>" src="<?php echo $strWeibo['user'][face];?>" width="48" /></a>
</li>
<li class="mbtr">
...
<a href="<?php echo tsurl('weibo','delete',array('weiboid'=>$strWeibo['weiboid']))?>">删除</a>
<?php } ?>
...
<span><a class="j a_confirm_link" href="<?php echo tsurl('weibo','comment',array('ts'=>'delete','commentid'=>$item['commentid']))?>" rel="nofollow">删除</a>
</span>
</div>
<?php } ?>
</div>
...
<div>
<form method="post" class="form text-form" action="<?php echo SITE_URL;?>index.php?app=weibo&ac=comment" enctype="multipart/form-data">
...
<div class="bc">
<div class="face">
<a href="<?php echo tsurl('user','space',array('id'=>$strWeibo['user'][userid]))?>" rel="face" uid="<?php echo $strWeibo['user'][userid];?>"><img title="<?php echo $strWeibo['user'][username];?>" alt="<?php echo $strWeibo['user'][username];?>" src="<?php echo $strWeibo['user'][face];?>" width="48"></a>
</div>

<div class="info">
<h3><a href=""><?php echo $strWeibo['user'][username];?></a></h3>
